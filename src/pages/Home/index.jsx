...
const Home = () => {
  ...
  return (
    <>
      ...
      <Container backgroundColor={BACKGROUND_COLOR} fluid>
        <Slide />
      </Container>
      <Container
        paddingVertical="75"
        paddingHorizontal={
          paddingByWidth + constants.PADDING_SAMPLE_PRODUCT + 'px'
        }
      >
        <SampleProduct />
      </Container>
      <Container
        backgroundImage={CommentBg}
        height="580"
        paddingVertical="102"
        paddingHorizontal={
          paddingByWidth + constants.PADDING_CUS_COMMENT + 'px'
        }
      >
        <CustomerComment />
      </Container>
      <Container
        paddingVertical="32"
        paddingHorizontal={paddingByWidth + constants.PADDING_FOOTER + 'px'}
      >
        <Footer />
      </Container>
      <Container
